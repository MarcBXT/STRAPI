...
import src from "../../assets/images/logo-json.png";
    ...
    <div className={"col-12"}>
      ...
      <Row className={"row"}>
        ...
        >
          ...
          <P>
            <span>{formatMessage({id: getTrad("manage-catalog-aes.drag.drop")})}</span>
          </P>
      ...
      <Row className={"row"}>
        <Button
          label={formatMessage({id: getTrad("manage-catalog-aes.button.import")})}
